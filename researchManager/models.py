...
class Researh(models.Model):
    ...
    date_accepted = models.DateField("Дата одобрения")
    date_created = models.DateField("Дата загрузки в систему")
...
class Files(models.Model):
    ...
    file = models.CharField("Путь к файлу", max_length=250)
...
class Information(models.Model):
    ...
    duration = models.DateField("Дата окончания исследования", null=True, blank=True)
